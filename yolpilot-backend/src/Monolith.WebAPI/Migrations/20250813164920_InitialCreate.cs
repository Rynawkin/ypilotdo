        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InviterId = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TempMembers", x => x.Token);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeZone = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true),
                    ...
                    CostPerHour = table.Column<double>(type: "float", nullable: true),
                    DefaultServiceTime = table.Column<TimeSpan>(type: "time", nullable: false),
                    MaximumDriverCount = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedServiceTime = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Latitude = table.Column<double>(type: "float", nullable: false),
                    Longitude = table.Column<double>(type: "float", nullable: false),
                    StartWorkingHours = table.Column<TimeSpan>(type: "time", nullable: false),
                    EndWorkingHours = table.Column<TimeSpan>(type: "time", nullable: true),
                    WorkspaceId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Depots_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedLocations_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vehicles_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Vehicles_AssignedVehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Drivers_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Routes_Workspaces_WorkspaceId",
                        column: x => x.WorkspaceId,
                        principalTable: "Workspaces",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Polyline = table.Column<string>(type: "nvarchar(max)", maxLength: 2147483647, nullable: true),
                    Date = table.Column<DateTime>(type: "datetime2", nullable: false),
                    StartedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteEndDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RouteEndDetails_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RouteStartDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RouteStartDetails_Routes_RouteId",
                        column: x => x.RouteId,
                        principalTable: "Routes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContactFullName = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: true),
                    ...
                    ProofOfDeliveryRequired = table.Column<bool>(type: "bit", nullable: false),
                    ArriveBetweenStart = table.Column<TimeSpan>(type: "time", nullable: true),
                    ArriveBetweenEnd = table.Column<TimeSpan>(type: "time", nullable: true),
                    ServiceTime = table.Column<TimeSpan>(type: "time", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JourneyEndDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JourneyEndDetails_Journeys_JourneyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JourneyStartDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JourneyStartDetails_Journeys_JourneyId",
                        column: x => x.JourneyId,
                        principalTable: "Journeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstimatedDepartureTime = table.Column<TimeSpan>(type: "time", nullable: true),
                    ArriveBetweenStart = table.Column<TimeSpan>(type: "time", nullable: true),
                    ArriveBetweenEnd = table.Column<TimeSpan>(type: "time", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_JourneyStops_RouteStops_RouteStopId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    Notes = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                    AdditionalValues = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Latitude = table.Column<double>(type: "float", nullable: false),
                    Longitude = table.Column<double>(type: "float", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JourneyStatuses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JourneyStatuses_JourneyStops_StopId",
                        column: x => x.StopId,
                        principalTable: "JourneyStops",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_JourneyStatuses_Journeys_JourneyId",
                        column: x => x.JourneyId,
                        principalTable: "Journeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_AssignedVehicleId",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Drivers_WorkspaceId",
                table: "Drivers",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_JourneyEndDetails_JourneyId",
                table: "JourneyEndDetails",
                column: "JourneyId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JourneyStartDetails_JourneyId",
                table: "JourneyStartDetails",
                column: "JourneyId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_JourneyStatuses_JourneyId",
                table: "JourneyStatuses",
                column: "JourneyId");

            migrationBuilder.CreateIndex(
                name: "IX_JourneyStatuses_StopId",
                table: "JourneyStatuses",
                column: "StopId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JourneyStops_RouteStopId",
                table: "JourneyStops",
                column: "RouteStopId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteEndDetails_RouteId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Routes_WorkspaceId",
                table: "Routes",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_RouteStartDetails_RouteId",
                table: "RouteStartDetails",
                column: "RouteId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedLocations_WorkspaceId",
                table: "SavedLocations",
                column: "WorkspaceId");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_WorkspaceId",
                table: "Vehicles",
                column: "WorkspaceId");
        }
