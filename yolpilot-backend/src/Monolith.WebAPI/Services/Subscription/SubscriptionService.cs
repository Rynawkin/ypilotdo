    ...
    public PlanLimits GetPlanLimits(PlanType planType)
    {
        return planType switch
        {
            ...
            PlanType.Growth => new PlanLimits
            {
                ...
                AdditionalStopPrice = 2.5m,
                HasCustomerWhatsAppNotifications = true,
                IncludedWhatsAppMessages = 150,
                AdditionalWhatsAppPrice = 0.70m,
                HasTimeWindows = true,
                HasCustomerSatisfactionReport = true,
                HasRouteTemplates = true,
                HasCustomReports = false,
                ProofArchiveDays = 120
            },
            ...
            PlanType.Business => new PlanLimits
            {
                ...
                MaxCustomers = null,
                MaxUsers = 75,
                IncludedMonthlyStops = 12000,
                AdditionalStopPrice = 1.2m,
                HasCustomerWhatsAppNotifications = true,
                IncludedWhatsAppMessages = 1500,
                AdditionalWhatsAppPrice = 0.35m,
                HasTimeWindows = true,
                HasCustomerSatisfactionReport = true,
                HasRouteTemplates = true,
