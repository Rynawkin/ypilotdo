...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden border-b border-[color:var(--line)] bg-transparent pb-18 pt-28 lg:pb-24 lg:pt-34">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-14 px-4 sm:px-6 lg:grid-cols-[minmax(0,1.02fr)_minmax(0,0.98fr)] lg:items-center lg:px-8">
        <motion.div
        ...
        <motion.div
          ...
          className="relative"
        >
          <div className="absolute inset-x-8 top-10 h-56 rounded-full bg-blue-600/12 blur-3xl" />

          <div className="relative flex flex-col gap-8 lg:flex-row lg:items-end lg:gap-8">
            ...
            <div className="relative flex-1">
              <div className="overflow-hidden rounded-[1.8rem] border border-slate-300 bg-slate-950 p-2 shadow-2xl shadow-slate-900/15">
                <div className="relative h-[235px] rounded-[1.2rem] bg-slate-950 sm:h-[290px] lg:h-[340px]">
                  <motion.div
                  ...
                  >
                    <Image
                      ...
                      fill
                      sizes="(min-width: 1024px) 620px, (min-width: 640px) 520px, 340px"
              ...
              <div className="mx-auto h-5 w-[88%] rounded-b-[1.4rem] bg-slate-700" />
              <div className="mx-auto mt-1 h-1.5 w-[92%] rounded-full bg-slate-800" />
