...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden border-b border-[color:var(--line)] bg-transparent pb-18 pt-28 lg:pb-24 lg:pt-34">
      ...
      <div className="relative mx-auto grid max-w-[1320px] gap-14 px-4 sm:px-6 lg:grid-cols-[minmax(540px,0.98fr)_minmax(0,1.02fr)] lg:items-center lg:px-8">
        <motion.div
        ...
        >
          ...
          <div className="relative flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-center lg:gap-6">
            <div className="relative w-full lg:max-w-[660px] xl:max-w-[720px]">
              <div className="mx-auto w-full overflow-hidden rounded-[1.85rem] border border-slate-300 bg-slate-950 p-3 shadow-2xl shadow-slate-900/15">
                <div className="relative aspect-[16/9.6] w-full rounded-[1.35rem] bg-slate-950">
                  <motion.div
                  ...
                  >
                    <Image
                      ...
                      fill
                      sizes="(min-width: 1536px) 720px, (min-width: 1280px) 660px, (min-width: 1024px) 620px, (min-width: 640px) 620px, 380px"
              ...
              <div className="mx-auto h-5 w-[30%] max-w-[190px] rounded-b-[1.3rem] bg-slate-700" />
              <div className="mx-auto mt-1.5 h-2 w-[42%] max-w-[300px] rounded-full bg-slate-800" />
            ...
            <div className="relative mx-auto lg:mx-0 lg:mb-2">
              <div className="relative h-[420px] w-52 rounded-[2.6rem] bg-slate-950 p-2 shadow-2xl shadow-slate-900/20 sm:h-[460px] sm:w-56 lg:h-[360px] lg:w-[164px] xl:h-[388px] xl:w-[176px]">
